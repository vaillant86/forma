...
func _ready():
	...
	spawn_quadrato("Pezzo_Q2", Vector2(1000, 500), Color.GOLD)
	spawn_triangolo("Pezzo_T1", Vector2(150, 100), Color.MEDIUM_PURPLE, 0)
	spawn_triangolo("Pezzo_T2", Vector2(1000, 100), Color.YELLOW_GREEN, 0)
